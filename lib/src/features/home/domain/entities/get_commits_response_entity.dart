...
class CommitsResponseModel {
  ...
  final CommitsResponseModelAuthor author;
  final CommitsResponseModelAuthor committer;
  ...
  factory CommitsResponseModel.fromJson(Map<String, dynamic> json) =>
      CommitsResponseModel(
        ...
        author: CommitsResponseModelAuthor.fromJson(json["author"]),
        committer: CommitsResponseModelAuthor.fromJson(json["committer"]),
        parents:
...
class CommitsResponseModelAuthor {
  final String login;
  final int id;
  final String nodeId;
  ...
  factory CommitsResponseModelAuthor.fromRawJson(String str) =>
      CommitsResponseModelAuthor.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory CommitsResponseModelAuthor.fromJson(Map<String, dynamic> json) =>
      CommitsResponseModelAuthor(
        login: json["login"],
        id: json["id"],
        nodeId: json["node_id"],
